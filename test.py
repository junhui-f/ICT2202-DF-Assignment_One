    ...
    def process(self, file):
        ...
        if file.getName().lower().endswith(".jpg"):            
            ...
            att = BlackboardAttribute(BlackboardAttribute.ATTRIBUTE_TYPE.TSK_SET_NAME,
                  FindBigRoundFilesIngestModuleFactory.moduleName, "Image found")
            ...
            with open('C:\\Users\\Kevin\\Desktop\\temp\\'+str(file.getName()), 'wb') as f:
            ...
            # x = subprocess.run(['cmd', '/C', 'python','C:\\Users\\Kevin\\Desktop\\2202 project\\detect.py','1.jpg'], stdout=subprocess.PIPE, shell=True).stdout
            # x = subprocess.run(['cmd', '/C', 'whoami'], stdout=subprocess.PIPE, shell=True).stdout
            x = subprocess.call('python \"C:\\Users\\Kevin\\Desktop\\2202 project\\detect.py\" monke.jpg', shell=True, cwd=os.path.expanduser('~'))
            with open('C:\\Users\\Kevin\\Desktop\\debug.txt', 'w+') as f2:
                f2.write(str(x))
